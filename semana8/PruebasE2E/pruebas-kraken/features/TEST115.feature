...
Scenario: TEST091
	...
	And I wait for 1 seconds
	And I set text "$string_3" on element with xpath "<FILTER_VIEW_INPUT_EXCERPT_XPATH>" 
	And I wait for 1 seconds
	And I set text "$name_1" on element with xpath "<FILTER_VIEW_INPUT_AUTHORS_XPHAT>" 
